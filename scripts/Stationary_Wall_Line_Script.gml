...
if (!position_meeting(x, y - sprite_height/2 - 1, Stationary_Wall)){
    ...
    if (instance_exists(ballid1)){ if (ballid1.vspeed > 2) {
...
if (!instance_position(x + sprite_width/2 + 1, y, Stationary_Wall)){
    ...
    if (instance_exists(ballid2)){ if (ballid2.hspeed < -2) {
...
if (!instance_position(x, y + sprite_height/2 + 1, Stationary_Wall)){
    ...
    if (instance_exists(ballid3)){ if (ballid3.vspeed < -2) {
...
if (!instance_position(x - sprite_width/2 - 1, y, Stationary_Wall)){
    ...
    if (instance_exists(ballid4)){ if (ballid4.hspeed > 2) {
